...
const ChartTooltipContent = React.forwardRef<
  HTMLDivElement,
  // Use the library's props type but accept unknown payloads; we keep the signature compatible.
                      ...
                      !hideIndicator && (
                        <div
                          className={cn(
                            ...
                            // cast object to any so cn accepts conditional class object
                            ( {
...
const ChartLegendContent = React.forwardRef<
  HTMLDivElement,
  React.ComponentProps<"div"> &
    // Use any for legend payload to avoid strict mismatch with Recharts type exports
